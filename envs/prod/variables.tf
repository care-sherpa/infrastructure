...
# Authorized Networks Variables
variable "postgres_authorized_networks" {
  description = "List of authorized networks for PostgreSQL instance access"
  type = list(object({
    name  = string
    value = string
  }))
...
variable "mysql_authorized_networks" {
  description = "List of authorized networks for MySQL instance access"
  type = list(object({
    name  = string
    value = string
  }))
